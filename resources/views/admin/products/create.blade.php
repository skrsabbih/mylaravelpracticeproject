                    ...
                    <div class="col-md-12">
                        <div class="card card-primary card-outline mb-4">
                            ...
                            <div class="card-header d-flex align-items-center">
                                <div class="card-title flex-grow-1">Create Product</div>
                                <div>
                            ...
                            <form action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea name="description" class="form-control @error('description') is-invalid @enderror">{{ old('address') }}</textarea>
                                        @error('description')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
