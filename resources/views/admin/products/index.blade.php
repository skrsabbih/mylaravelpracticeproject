                            ...
                            <div class="col-md-12">
                                <div class="card mb-4">
                                    <div class="card-header d-flex align-items-center">
                                        <h3 class="card-title flex-grow-1">Products List</h3>
                                        @role(['admin', 'operator'])
                                            <a href="{{ route('products.create') }}" class="btn btn-sm btn-primary">
                                                <i class="bi bi-plus-circle"></i> Product Create
                                            </a>
                                        @endrole
                                    </div>
                                    <!-- /.card-header -->
                                            ...
                                            <tbody>
                                                @foreach ($products as $product)
                                                    <tr class="align-middle">
                                                        ...
                                                        <td>
                                                            @if ($product->image)
                                                                <img src="{{ asset('storage/' . $product->image) ? asset('storage/' . $product->image) : asset('assets/img/no-image.png') }}"
                                                                    alt="product_image" srcset="" width="50">
                                                            @endif
                                                        </td>
                                                        <td>
                                                            <div class="btn-group">
